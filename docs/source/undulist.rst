...
Calculations of Radiation Properties using the wave module
================
...
The x coordinate denotes the longitudinal direction, i.e. along the design orbit of the beam. The y-direction is the vertical- and z is horizontal direction. 
