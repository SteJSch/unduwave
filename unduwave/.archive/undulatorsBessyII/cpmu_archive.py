...
def cpmuPolFun(center,polParas,name='pol') : 

	pnts_side1 = [
		np.array([
			-polParas._len_x_main()/2.0,
			polParas._len_y_side_middle()/2.0-polParas._cliff_side(),
			-polParas._len_z_side()/2.0
			]),
		np.array([
			-polParas._len_x_main()/2.0,
			polParas._len_y_side_middle()/2.0,
			-polParas._len_z_side()/2.0+polParas._cliff_side()
			]),
		np.array([
			-polParas._len_x_main()/2.0,
			polParas._len_y_side_middle()/2.0,
	...
	p_main[2] = p_main[2] - polParas._len_z_main()/2.0
	...
	p_usl[1] = p_main[1] - polParas._len_y_main()/2.0 + polParas._len_y_side_low() + polParas._len_y_side_middle()/2.0
	p_usl[2] = p_usl[2] - polParas._len_z_main() - polParas._len_z_side()/2.0
	upper_side_block_left_paras=undu_magnets.magnetParameters(
		segm_x = polParas._segm_x(), 
		segm_y = 1, 
		segm_z = 1, 
		frac_y=1,
		frac_z=1,
	...
	upper_side_block_left = undu_magnets.undu_magnet_block_coords(
		p_center=p_usl,
		magnetParameters=upper_side_block_left_paras,
	...
	p_lsl[1] = p_main[1] - polParas._len_y_main()/2.0 + polParas._len_y_side_low()/2.0
	p_lsl[2] = p_lsl[2] - polParas._len_z_main() - polParas._len_z_side()/2.0
	lower_side_block_left_paras=undu_magnets.magnetParameters(
		segm_x = polParas._segm_x(), 
		segm_y = 1, 
		segm_z = 1, 
		frac_y=1,
	...
	lower_side_block_left = undu_magnets.undu_magnet_block_coords(
		p_center=p_lsl,
		magnetParameters=lower_side_block_left_paras,
	...
	p_usr[1] = p_main[1] - polParas._len_y_main()/2.0 + polParas._len_y_side_low() + polParas._len_y_side_middle()/2.0
	p_usr[2] = p_usr[2] + polParas._len_z_main() + polParas._len_z_side()/2.0
	upper_side_block_right_paras=undu_magnets.magnetParameters(
		segm_x = polParas._segm_x(), 
		segm_y = 1, 
		segm_z = 1, 
		frac_y=1,
	...
	upper_side_block_right = undu_magnets.undu_magnet_block_coords(
		p_center=p_usr,
		magnetParameters=upper_side_block_right_paras,
		pnts=copy.deepcopy(pnts_side1),
	...
	p_lsr[1] = p_main[1] - polParas._len_y_main()/2.0 + polParas._len_y_side_low()/2.0
	p_lsr[2] = p_lsr[2] + polParas._len_z_main() + polParas._len_z_side()/2.0
	lower_side_block_right_paras=undu_magnets.magnetParameters(
		segm_x = polParas._segm_x(), 
		segm_y = 1, 
		segm_z = 1, 
		frac_y=1,
	...
	lower_side_block_right = undu_magnets.undu_magnet_block_coords(
		p_center=p_lsr,
		magnetParameters=lower_side_block_right_paras,
		pnts=copy.deepcopy(pnts_side2),
	...
	# return undu_magnets.undu_magnets(
...
def cpmuMagnetFun(center,magnParas,name) :

	name_main = combine_strings(str_add='main',str_add_to=name)
	p_main = copy.deepcopy(center)

	p_main[2] = p_main[2] - magnParas._len_z_main()/2.0
	main_block = undu_magnets.undu_magnet_block_coords(
		p_center=p_main,
	...
	p_side_left[1] = p_side_left[1] + magnParas._len_y_main()/2.0 - \
		(magnParas._len_y_main()-magnParas._len_y_side() )-magnParas._len_y_side()/2.0
	p_side_left[2] = p_side_left[2]-magnParas._len_z_main()-magnParas._len_z_side()/2.0
	magnParasSide=undu_magnets.magnetParameters(
		len_x_main=magnParas._len_x_main(),
		len_y_main=magnParas._len_y_side(), 
		len_z_main=magnParas._len_z_side(), 
		magnetization=magnParas._magnetization(),
		magn_unit_vec=magnParas._magn_unit_vec(),
		segm_x = magnParas._segm_x, 
		segm_y = 1, 
		segm_z = 1, 
		frac_y=1,
		frac_z=1,
	...
	side_left = undu_magnets.undu_magnet_block_coords(
		p_center=p_side_left,
		magnetParameters=magnParasSide,
		pnts=None,
		name=name_s1,
		mother=name,
		api=None
	...
	p_side_right[1] = p_side_right[1] + magnParas._len_y_main()/2.0 - \
		(magnParas._len_y_main()-magnParas._len_y_side() )-magnParas._len_y_side()/2.0
	p_side_right[2] = p_side_right[2]+magnParas._len_z_main()+magnParas._len_z_side()/2.0
	side_right = undu_magnets.undu_magnet_block_coords(
		p_center=p_side_right,
		magnetParameters=magnParasSide,
		pnts=None,
		name=name_s2,
		mother=name,
	...
	return undu_magnets.undu_magnets(magnet_blocks=[main_block,side_left])
	# return undu_magnets.undu_magnets(magnet_blocks=[main_block,side_left,side_right])
...
def getCPMU20Paras_OldOptm() :
	...
	endMagn1Paras=undu_magnets.magnetParameters(
		len_x_main=6.3, 
		len_y_main=32.8,
		len_z_main=37.8/2.0, 
		segm_x=4,
	...
	endMagn2Paras=undu_magnets.magnetParameters(
		len_x_main=6.5, 
		len_y_main=12.8,
		len_z_main=48.4/2.0, 
		segm_x=4,
