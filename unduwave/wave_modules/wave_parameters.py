...
class ebeam_parameters(_attribute_collection):
	...
	def get_std_paras(self): 
		...
		self.betaFunctionHor.set(1) #  horizontal beta functions [m]
		self.betaFunctionVer.set(1) #  vertical beta functions [m]
...
class wave_prog_parameters(_attribute_collection):
	...
	def __init__(self) :
		...
		self.applyFilter=_attribute(0,in_name='IEFFI')
		self.filterFile=_attribute('')
		self.powerOutputObsrvtnPnts=_attribute(0,in_name='IWFILPOW')
		self.magseq=_attribute(0,in_name='KMAGSEQ')
		self.magseqFile=_attribute('')
	...
	def get_std_paras(self, wave_mode = 'undu_easy' ): 
		...
		self.ipin.set(1)
		self.observationPnts.set(0)
		self.observationFile.set('')
		self.cx1.set(9999.)
		self.cy1.set(9999.)
		self.cz1.set(9999.)
		self.wc1.set(9999.)
		...
		self.wc2.set(9999.)
		self.hc2.set(9999.)
		self.powerOutputObsrvtnPnts.set(0)
		self.magseq.set(0)
		self.magseqFile.set('')
		self.applyFilter.set(0)
		self.filterFile.set('')
