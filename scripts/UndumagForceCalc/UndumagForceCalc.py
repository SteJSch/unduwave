...
undu_center_1 = undu_magnets.point_coords(x=10.0,y=-20,z=0)
undu_center_2 = undu_magnets.point_coords(x=-10.0,y=-20,z=0)
magn_unit_vec=undu_magnets.create_magnetization_unit_vec(magn_string='+x')

block1 = undu_magnets.undu_magnet_block_coords(
	p_center=undu_center_1,
	len_x=10,
	len_y=20,
	len_z=20,
	magnetization=1.12,
...
block2 = undu_magnets.undu_magnet_block_coords(
	p_center=undu_center_2,
	len_x=10,
	len_y=20,
	len_z=20,
	magnetization=1.12,
...
magn_sys = undu_magnets.undu_magnets(magnet_blocks=[block1,block2],api=undu)
magn_sys.add_to_clc()

undu.set_force_calc(object=block2)
