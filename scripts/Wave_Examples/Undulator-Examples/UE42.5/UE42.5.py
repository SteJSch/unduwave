...
shift = 0.25 # percent of 1 period
nperiods = 7
...
undu_paras.unduParameterKZ.set(K_para_z)
...
flux_dens_distr_ens_loaded = results.find_load_flux_density_distribution(energies=[460,490])
