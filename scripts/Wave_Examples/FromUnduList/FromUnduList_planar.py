...
Getting wave
"""
wave = uw.wave(wave_mode='undu_endp')
...
undu_paras.set_paras_from_bessyII_undu_list(ebeam=ebeam_paras,unduName='U49_2')
...
spectrometer_paras.spectrum_n_energies.set(50)
