...
K_para_y = np.linspace(0.5,2.142,10) # Possible K-Values in horizontal (z) mode
K_para_y=K_para_y[0] 
...
# undu_paras.planarUnduK.set(K_para_y)
undu_paras.planarUnduNumPeriods.set(2*nperiods+1) # we count the number of B-field peaks here - one extra for the end-fields (odd)
undu_paras.planarUnduPerLength.set(period_length)
