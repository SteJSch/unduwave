...
K_para_z = np.linspace(0.5,5.3,10) # Possible K-Values in horizontal (z) mode
K_para_z=K_para_z[0] 
K_para_y=0.0

K_para_y = np.linspace(0.5,3.82,10)  # Possible K-Values in vertical (y) mode
K_para_z=0.0
K_para_y=K_para_y[0]

K_para_c = np.linspace(0.5,4.38,10)  # Possible K-Values in circular mode
K_para_z=K_para_c[0]
K_para_y=K_para_c[0]

period_length = 0.056 # m
